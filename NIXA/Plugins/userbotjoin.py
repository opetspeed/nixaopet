...
from NIXA.Modules.decorators import authorized_users_only, sudo_users_only, errors
...
async def join_group(client, message):
    ...
    try:
        ...
        return
    await message.reply_text(
        f"✅ **ᴀssɪsᴛᴀɴᴛ sᴜᴄᴄᴇsғᴜʟʟʏ ᴇɴᴛᴇʀᴇᴅ ᴄʜᴀᴛ**",
    )
...
async def leave_one(client, message):
    try:
        ...
        await message.reply_text(
            "❌ **ᴀssɪsᴛᴀɴᴛ ᴄᴏᴜʟᴅ ɴᴏᴛ ʟᴇᴀᴠᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘ, ᴍᴀʏ ʙᴇ ғʟᴏᴏᴅᴡᴀɪᴛs.**\n\n**» ᴏʀ ᴍᴀɴᴜᴀʟʟʏ ᴋɪᴄᴋ ᴜsᴇʀʙᴏᴛ ғʀᴏᴍ ʏᴏᴜʀ ɢʀᴏᴜᴘ**"
        )
