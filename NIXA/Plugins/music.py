...
import aiofiles
import aiohttp
from NIXA.Modules.converter import convert
import ffmpeg
import requests
from NIXA.Modules.fonts import CHAT_TITLE
from PIL import Image, ImageDraw, ImageFont
from config import ASSISTANT_NAME, BOT_USERNAME, IMG_1, IMG_2, IMG_5, UPDATES_CHANNEL, GROUP_SUPPORT
from NIXA.Modules.filters import command, other_filters
from NIXA.Modules.queues import QUEUE, add_to_queue
from NIXA.main import call_py, Test as user
from NIXA.Modules.utils import bash
...
NIXA_IMGS = [
    "NIXA/Modules/ImageFont/Red.png",
    "NIXA/Modules/ImageFont/Black.png",
    "NIXA/Modules/ImageFont/Blue.png",
    "NIXA/Modules/ImageFont/Grey.png",
    "NIXA/Modules/ImageFont/Green.png",
    "NIXA/Modules/ImageFont/Lightblue.png",
    "NIXA/Modules/ImageFont/Lightred.png",
    "NIXA/Modules/ImageFont/Purple.png",
    "NIXA/Modules/ImageFont/Nixa.png",
]
...
async def generate_cover(thumbnail, title, userid, ctitle):
    ...
    font = ImageFont.truetype("NIXA/Modules/ImageFont/finalfont.ttf", 60)
    font2 = ImageFont.truetype("NIXA/Modules/ImageFont/finalfont.ttf", 70)     
