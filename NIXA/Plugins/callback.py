import yt_dlp
from NIXA.Modules.queues import QUEUE
from pyrogram import Client, filters
from pyrogram.types import CallbackQuery, InlineKeyboardButton, InlineKeyboardMarkup
from NIXA.Modules.inline import menu_markup, song_download_markup, stream_markup, audio_markup
...
async def song_helper_cb(client, CallbackQuery):
    ...
    videoid, user_id = callback_request.split("|")
    try:
        await CallbackQuery.answer("!! sᴏᴏɴ !!", show_alert=True)
    except:
        pass
    if stype == "audio":
        try:
        ...
        keyboard = InlineKeyboard()
        # AVC Formats Only [ NIXA MUSIC BOT ]
